...
CPP_SRCS += $(shell find $(WORKSPACE_DIR) -name *.cpp)
ALLOBJ   += $(CPP_SRCS:$(WORKSPACE_DIR)/%.cpp=$(WORKSPACE_DIR)/%.o)
ALLDEPS += $(CPP_SRCS:$(WORKSPACE_DIR)/%.cpp=$(WORKSPACE_DIR)/%.d)

# Each subdirectory must supply rules for building sources it contributes
$(WORKSPACE_DIR)/%.o: $(WORKSPACE_DIR)/%.cpp
